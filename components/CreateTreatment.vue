    ...
    <div class="container">
        <div class="row">
            <div class="row mx-0 px-4">
                <h2 class="col pt-4 s12 mb-0 pb-0">Create a treatment that you think is necessary</h2>
                <p class="col pb-4 pt-2 text-super-light s12">
                    <span class="mdi mdi-information-outline"></span>
                    Once you add your treatment, it will be then visible to all the registered users.
                </p>
                <div class="col s12">
                    <div class="bg-light px-3 py-1">
                        <div class="input-field border-bottom-0">
                            <input type="text" class="validate my-0"  placeholder="Treatment Title" v-model="title">
                        </div>
                    </div>
                </div>
    ...
    methods: {
        create() {
            ...
            this.firebase_push_db({ ref, obj }, (res) => {
                ...
                this.loading = false
                M.toast({ html: "Treatment Added Successfully!" })                
            },
